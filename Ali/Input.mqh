...
// input ENUM_CLOSE_ALL_POSITION closeAllPosition = ENUM_CLOSE_ALL_POSITION::DISABLE; // Close All Position
input ENUM_CLOSE_ALL_TRIGGER closeAllTrigger = ENUM_CLOSE_ALL_TRIGGER::DISABLE; // Close All Symbol
