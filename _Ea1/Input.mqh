...
input string bb2 = "========== (BB) 2# indikator BB ==========";   // ​
...
input string bb3 = "========== (BB) 3# indikator BB ==========";   // ​
...
input string bb4 = "========== (BB) 4# indikator BB ==========";   // ​
...
input string bb5 = "========== (BB) 5# indikator BB ==========";   // ​
...
input string _16 = "========== (BB) 6# indikator BB ==========";   // ​
...
input ENUM_ACTIVE_DISABLE bb6_buy = ACTIVE;                        // Signal Buy
input ENUM_ACTIVE_DISABLE bb6_sell = ACTIVE;                       // Signal Sell
...
input ENUM_APPLIED_PRICE bb6_price = PRICE_CLOSE;                  // Bolingger Bands Applied Price